...
public:
	...
	Camera(glm::vec3 pos = glm::vec3(0.0f, 0.0f, 0.0f), float horizontalAngle = 0.0f, float verticalAngle = 0.0f);
	~Camera();
...
private:
	...
	float nearClippingPlane = 1.0f; // Ближняя плоскость отсечения
